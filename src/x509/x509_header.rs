...
const MBEDTLS_X509_KU_DIGITAL_SIGNATURE            : i32 = 0x80;  /* bit 0 */
const MBEDTLS_X509_KU_NON_REPUDIATION              : i32 = 0x40;  /* bit 1 */
const MBEDTLS_X509_KU_KEY_ENCIPHERMENT             : i32 = 0x20;  /* bit 2 */
const MBEDTLS_X509_KU_DATA_ENCIPHERMENT            : i32 = 0x10;  /* bit 3 */
const MBEDTLS_X509_KU_KEY_AGREEMENT                : i32 = 0x08;  /* bit 4 */
const MBEDTLS_X509_KU_KEY_CERT_SIGN                : i32 = 0x04;  /* bit 5 */
const MBEDTLS_X509_KU_CRL_SIGN                     : i32 = 0x02;  /* bit 6 */
const MBEDTLS_X509_KU_ENCIPHER_ONLY                : i32 = 0x01;  /* bit 7 */
const MBEDTLS_X509_KU_DECIPHER_ONLY              : i32 = 0x8000;  /* bit 8 */

const MBEDTLS_X509_NS_CERT_TYPE_SSL_CLIENT         : i32 = 0x80;  /* bit 0 */
const MBEDTLS_X509_NS_CERT_TYPE_SSL_SERVER         : i32 = 0x40;  /* bit 1 */
const MBEDTLS_X509_NS_CERT_TYPE_EMAIL              : i32 = 0x20;  /* bit 2 */
const MBEDTLS_X509_NS_CERT_TYPE_OBJECT_SIGNING     : i32 = 0x10;  /* bit 3 */
const MBEDTLS_X509_NS_CERT_TYPE_RESERVED           : i32 = 0x08;  /* bit 4 */
const MBEDTLS_X509_NS_CERT_TYPE_SSL_CA             : i32 = 0x04;  /* bit 5 */
const MBEDTLS_X509_NS_CERT_TYPE_EMAIL_CA           : i32 = 0x02;  /* bit 6 */
const MBEDTLS_X509_NS_CERT_TYPE_OBJECT_SIGNING_CA  : i32 = 0x01;  /* bit 7 */
