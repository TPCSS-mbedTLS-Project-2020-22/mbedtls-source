...
fn test_01() {
    ...
    println!("{:?}", ctx);
    crate::aes::mbedtls_aes_setkey_enc(
        &mut ctx,
...
fn test_aes_enc_01() {
    ...
    crate::aes::mbedtls_aes_setkey_enc(&mut ctx, &key, 128);
    crate::aes::mbedtls_aes_crypt_ecb(
        &ctx,
        crate::aes::MBEDTLS_AES_ENCRYPT,
        &plaintext,
        &mut ciphertext,
    );
...
fn test_aes_enc_cbc_01() {
    ...
    crate::aes::mbedtls_aes_setkey_enc(&mut ctx, &key, 128);
    crate::aes::mbedtls_aes_crypt_cbc(
        &ctx,
        crate::aes::MBEDTLS_AES_ENCRYPT,
        64,
        &iv,
...
fn test_aes_enc_ofb_01() {
    ...
    crate::aes::mbedtls_aes_setkey_enc(&mut ctx, &key, 128);
    crate::aes::mbedtls_aes_crypt_ofb(&ctx, 64, &mut iv_off, &mut iv_enc, &plaintext, &mut ciphertext);
    crate::aes::mbedtls_aes_crypt_ofb(&ctx, 64, &mut iv_off, &mut iv_dec, &ciphertext, &mut decrypted_msg);
