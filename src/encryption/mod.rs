...
pub const MBEDTLS_XTEA_DECRYPT: i32=0;
pub const MBEDTLS_ERR_XTEA_INVALID_INPUT_LENGTH: i32=-0x0028;
pub const MBEDTLS_ERR_XTEA_HW_ACCEL_FAILED: i32=-0x0029;
